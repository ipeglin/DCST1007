...
export let pool = mysql.createPool({
  ...
  user: 'ianpe', // Replace "username" with your mysql-ait.stud.idi.ntnu.no username
  password: 'T9j3B7qV', // Replae "password" with your mysql-ait.stud.idi.ntnu.no password
  database: 'ianpe', // Replace "username" with your mysql-ait.stud.idi.ntnu.no username
});
